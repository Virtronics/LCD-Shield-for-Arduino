...
// v1.03 13-Oct-2015 - add double beep on startup
...
{
  tone(BeeperPin,1843,400); // beep high sound
  delay(650); // wait for 400ms beep and 250 ms silence
  tone(BeeperPin,553,400);
}
